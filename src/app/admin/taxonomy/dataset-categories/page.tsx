...
import { FaDatabase, FaPlus, FaEdit, FaTrash, FaArrowLeft } from 'react-icons/fa';
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2">Manage categories for AI datasets</p>
      </div>
              ...
              <div key={category.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="text-xs text-gray-400 mt-2">
                    Used in {category.count} dataset(s)
                  </p>
                </div>
