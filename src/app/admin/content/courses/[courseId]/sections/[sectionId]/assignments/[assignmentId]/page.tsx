...
export default function EditAssignment() {
  ...
  }, [status, session, router, courseId, sectionId, assignmentId]);
  ...
  const fetchAssignment = async () => {
    try {
      ...
      setFormData({
        ...
        points: data.assignment.points || 10,
        due_date: data.assignment.due_date || '',
        submission_type: data.assignment.submission_type || 'text',
        order_index: data.assignment.order_index || 0
      });
    } catch (err) {
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="mb-6" aria-label="Breadcrumb">
        <ol className="flex space-x-2 text-sm text-gray-500">
          ...
          <li className="flex items-center">
            ...
            <span className="ml-2 text-gray-900 font-medium">Edit Assignment</span>
          </li>
        </ol>
      </nav>
      ...
      <div className="bg-white shadow-md rounded-lg overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h1 className="text-xl font-medium text-gray-900">Edit Assignment</h1>
        </div>
