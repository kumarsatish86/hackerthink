...
export const metadata: Metadata = {
  title: 'AI Courses - HackerThink',
  description: 'Browse, filter, and discover AI courses — HuggingFace-style discovery',
};
      ...
      <div className="bg-gradient-to-r from-red-600 to-red-700 text-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold">AI Courses</h1>
              <p className="text-red-100 mt-1">
                Browse, filter, and learn — same explorer pattern as Models & Datasets
              </p>
            </div>
          </div>
        </div>
